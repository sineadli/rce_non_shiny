...
module.exports = function (app, passport) {
    ...
    app.get('/matching', isLoggedIn, function (req, res) {
        ...
        res.render('matching.html', { user: req.user.local.email,  start_date: sess.eval.created_at, status: sess.eval.status, title: sess.eval.title, planQuestion: sess.eval.planQuestion });
    });
    ...
    app.get('/getresult', isLoggedIn, function (req, res) {
        ...
        res.render('getresult.html', { user: req.user.local.email, start_date: sess.eval.created_at, status: sess.eval.status, title: sess.eval.title, planQuestion: sess.eval.planQuestion });
    });
    ...
    app.get('/shareresult', isLoggedIn, function (req, res) {
        ...
        res.render('shareresult.html', { user: req.user.local.email, start_date: sess.eval.created_at, status: sess.eval.status, title: sess.eval.title, planQuestion: sess.eval.planQuestion });
    });
